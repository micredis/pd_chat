(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AppComponent = /** @class */ (function () {
                function AppComponent(router, authService) {
                    ...
                    this.title = 'client';
                    this.authService.currentUser.subscribe(function (value) { return _this.currentUser = value; });
                }
                return AppComponent;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AboutComponent = /** @class */ (function () {
                function AboutComponent(http, dialogRef) {
                    this.http = http;
                ...
                AboutComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this.getInfo().subscribe(function (res) {
                        console.log(res);
                        _this.name = res.build.name;
                        _this.version = res.build.version;
                        _this.buildDate = res.build.time;
                    });
                };
                AboutComponent.prototype.getInfo = function () {
                    return this.http.get(this.url);
                };
                AboutComponent.prototype.onCancel = function () {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var LoginComponent = /** @class */ (function () {
                function LoginComponent(authService, router, snackBar, formBuilder, route) {
                    this.authService = authService;
                    this.router = router;
                ...
                LoginComponent.prototype.onSubmit = function () {
                    ...
                    this.authService.login(this.email.value, this.password.value)
                        ...
                        _this.router.navigate([_this.returnUrl]).then();
                    }, function (error) {
                        _this.error = error;
                        _this.loading = false;
                    });
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var NavigationComponent = /** @class */ (function () {
                function NavigationComponent(breakpointObserver, dialog, authService, router) {
                ...
                NavigationComponent.prototype.getUsers = function () {
                    this.router.navigate(['/users']).then();
                };
                NavigationComponent.prototype.openMessages = function () {
                    this.router.navigate(['/home']).then();
                };
                NavigationComponent.prototype.about = function () {
                    this.dialog.open(_about_about_component__WEBPACK_IMPORTED_MODULE_2__["AboutComponent"], { disableClose: false });
                };
                NavigationComponent.prototype.isAuthenticated = function () {
                ...
                NavigationComponent.prototype.toggleOverlay = function (event) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var NewUserDialogComponent = /** @class */ (function () {
                ...
                NewUserDialogComponent.prototype.getEmailErrorMessage = function () {
                    return this.email.hasError('required') ? 'You must enter a value' :
                        this.email.hasError('email') ? 'Not a valid email' :
                            '';
                };
                NewUserDialogComponent.prototype.getLoginErrorMessage = function () {
                    return this.email.hasError('required') ? 'You must enter a value' :
                        this.email.hasError('login') ? 'Not a valid login' :
                            '';
                };
                NewUserDialogComponent.prototype.getPasswordErrorMessage = function () {
                    return this.email.hasError('required') ? 'You must enter a value' :
                        this.email.hasError('password') ? 'Not a valid password' :
                            '';
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var NewUserDialogModule = /** @class */ (function () {
                function NewUserDialogModule() {
                }
                return NewUserDialogModule;
            }());
            ...
            var RegistrationComponent = /** @class */ (function () {
                ...
                RegistrationComponent.prototype.onSubmit = function () {
                    ...
                    this.authService.registration(user)
                        ...
                        .subscribe(function (data) {
                        _this.router.navigate([_this.loginUrl]).then();
                    }, function (error) {
                        _this.error = error;
                        _this.loading = false;
                    });
                };
                RegistrationComponent.prototype.getFullNameErrorMessage = function () {
                    return this.email.hasError('required') ? 'You must enter a value' :
                        this.email.hasError('full_name') ? 'Not a valid full name' :
                            '';
                };
                ...
                RegistrationComponent.prototype.getLoginErrorMessage = function () {
                    return this.email.hasError('required') ? 'You must enter a value' :
                        this.email.hasError('login') ? 'Not a valid login' :
                            '';
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var UserEditDialogComponent = /** @class */ (function () {
                function UserEditDialogComponent(dialogRef, userService, router, location, data) {
                    this.dialogRef = dialogRef;
                    this.userService = userService;
                    this.router = router;
                    this.location = location;
                ...
                UserEditDialogComponent.prototype.getFullNameErrorMessage = function () {
                    return this.email.hasError('required') ? 'You must enter a value' :
                        this.email.hasError('full_name') ? 'Not a valid full name' :
                            '';
                };
                UserEditDialogComponent.prototype.getEmailErrorMessage = function () {
                    return this.email.hasError('required') ? 'You must enter a value' :
                        this.email.hasError('email') ? 'Not a valid email' :
                            '';
                };
                UserEditDialogComponent.prototype.getLoginErrorMessage = function () {
                    return this.email.hasError('required') ? 'You must enter a value' :
                        this.email.hasError('login') ? 'Not a valid login' :
                            '';
                };
                UserEditDialogComponent.prototype.getPasswordErrorMessage = function () {
                    return this.email.hasError('required') ? 'You must enter a value' :
                        this.email.hasError('password') ? 'Not a valid password' :
                            '';
                };
                UserEditDialogComponent.prototype.getRoleErrorMessage = function () {
                    return this.email.hasError('required') ? 'You must enter a value' :
                        this.email.hasError('role') ? 'Not a valid role' :
                            '';
                };
                UserEditDialogComponent.prototype.getActiveErrorMessage = function () {
                    return this.email.hasError('required') ? 'You must enter a value' :
                        this.email.hasError('active') ? 'Not a valid active' :
                            '';
                };
                UserEditDialogComponent.prototype.onCancel = function () {
                    this.dialogRef.close();
                };
                UserEditDialogComponent.prototype.delete = function () {
                    this.userService.delete(this.user.id).subscribe();
                    this.dialogRef.close();
                    this.refreshUsers();
                };
                UserEditDialogComponent.prototype.refreshUsers = function () {
                    var _this = this;
                    this.router.navigateByUrl('/UsersComponent', { skipLocationChange: true }).then(function () {
                        _this.router.navigate([decodeURI(_this.location.path())]).then();
                    });
            ...
            UserEditDialogComponent.ctorParameters = function () { return [
                { type: _angular_material_dialog__WEBPACK_IMPORTED_MODULE_2__["MatDialogRef"] },
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var UsersComponent = /** @class */ (function () {
                ...
                UsersComponent.prototype.selected = function (row) {
                    var user = {
                        id: row.id,
                        fullName: row.fullName,
                        email: row.email,
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AuthGuard = /** @class */ (function () {
                ...
                AuthGuard.prototype.canActivate = function (rout, state) {
                    var currentUser = this.authService.currentUserValue;
                    if (currentUser) {
                    ...
                    this.router.navigate(['/login'], { queryParams: { returnUrl: state.url } }).then(function (r) {
                        return false;
                    });
                    return false;
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var BasicAuthInterceptor = /** @class */ (function () {
                ...
                BasicAuthInterceptor.prototype.intercept = function (req, next) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AuthService = /** @class */ (function () {
                ...
                AuthService.prototype.login = function (email, password) {
                    var _this = this;
                    var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]().set('Authorization', "Basic " + window.btoa(email + ':' +
                        password));
